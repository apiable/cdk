...
Hand-rolled HCL module that provisions the `apiable-gateway-management-role-<region>` IAM role — the Terraform channel of the gateway-management role, equivalent to the one-click CFN stack in `lib/gateway-role`.
