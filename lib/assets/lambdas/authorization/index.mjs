...
const enforceJwtToken  = !process.env.ALLOW_PLAIN_API_KEY || process.env.ALLOW_PLAIN_API_KEY === 'false'
...
export const handler = async (event, context) => {
    ...
    console.log(payload["cognito:username"], JSON.stringify(user, null, 2))
    ...
    if (enforceJwtToken) {
        ...
        console.log("Skipping JWT decode check .env is set to 'ALLOW_PLAIN_API_KEY=true' . This is not recommended, as it may allow plain API keys to be used as tokens and lead to security issues.")
    }
