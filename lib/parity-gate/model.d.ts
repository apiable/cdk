 ...
 */
export declare const ACCOUNT_TOKEN = "{account}";
export declare const REGION_TOKEN = "{region}";
/**
 ...
 */
export declare const normaliseLogical: (value: string, region?: string) => string;
/** A wildcard principal — "any principal" — preserved as a sentinel that can never equal a bounded account set. */
export declare const WILDCARD_PRINCIPAL = "*";
/**
 ...
 */
export declare const NO_EXTERNAL_GRANTEE = "{none}";
/**
 ...
 */
export declare const NO_HOSTED_DOMAIN = "{none}";
/**
 ...
 */
export declare const grantedAccountsValue: (resolvedPrincipals: readonly string[], deployAccount?: string) => string;
/**
 ...
 */
export declare const accountIdsIn: (value: string) => readonly string[];
/**
 ...
 */
export declare const namespaceByRef: (values: LoadBearingValues, ref: string) => LoadBearingValues;
/**
 ...
 */
export declare const identityCollisionsOf: (valueBearingNodeRefs: readonly string[]) => string[];
/** The pool's channel-stable discriminator from its node ref (`cognito-user-pool:authz` → `authz`). */
export declare const poolNameFromRef: (poolRef: string) => string;
/**
 ...
 */
export declare const cognitoDiscovery: (poolName: string, region: string | undefined, domainPrefix: string | undefined) => OidcDiscovery;
/**
 ...
 */
export declare const discoveryValueRows: (poolRef: string, region: string | undefined, domainPrefix: string | undefined) => Record<string, string>;
