...
export EXAMPLE="./deploy-authz.sh 034444869755 eu-central-1 eu-central-1_sGgtSTd9j arn:aws:iam::034444869755:role/ApiableCognitoAuthZ-portal-dev JWT dev arn:aws:iam::034444869755:role/ApiableGetaway"
